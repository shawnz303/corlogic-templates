    ...
    <div class="table__group">
        <div class="table-items">
            <div class="table-item table-item--sm table-item--fluid">
                <h5>
                    <a :href="transmissionReportLink(id, {full_name: true})" target="_blank">
            ...
            <div class="table-item table-item--sm table-item--center">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="15" viewBox="0 0 16 15" @click="editTransmission(true)">
